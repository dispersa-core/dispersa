...
Dispersa detects and reports circular reference chains. If Token A references Token B, and Token B references Token A (directly or transitively), the build will fail with a clear error.
</Aside>
