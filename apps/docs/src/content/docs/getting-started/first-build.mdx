...
**`tokens/semantic/colors.json`** creates purpose-driven names that reference the base tokens. Names follow the six-layer convention: `category.concept.sentiment.prominence.state.scale` (layers can be omitted when not needed):
  ...
  "sets": {
    ...
    "typography": {
      "sources": [
        ...
        { "$ref": "./tokens/semantic/typography.json" }
      ]
    },
    "spacing": {
      "sources": [
        { "$ref": "./tokens/base/spacing.json" },
        { "$ref": "./tokens/semantic/spacing.json" }
      ]
    },
    "effects": {
      "sources": [
        { "$ref": "./tokens/base/effects.json" },
        { "$ref": "./tokens/semantic/effects.json" }
      ]
    }
  },
  "modifiers": {
