...
| file | `string \| FileFunction` | Output path; supports `{modifier}` placeholders or function |
...
```typescript
css(config: CssOutputConfig): OutputConfig
```

### CssOutputConfig (extends OutputConfig)
...
```typescript
json(config: JsonOutputConfig): OutputConfig
```

### JsonOutputConfig (extends OutputConfig)

| Option | Type | Default | Description |
|--------|------|---------|-------------|
| preset | `'bundle' \| 'standalone'` | `'standalone'` | Output preset |
| structure | `'flat' \| 'nested'` | `'flat'` | Token structure |
...
```typescript
js(config: JsOutputConfig): OutputConfig
```

### JsOutputConfig (extends OutputConfig)

| Option | Type | Default | Description |
|--------|------|---------|-------------|
| preset | `'bundle' \| 'standalone'` | `'standalone'` | Output preset |
| structure | `'flat' \| 'nested'` | `'flat'` | Token structure |
| moduleName | `string` | — | Export name |
| generateHelper | `boolean` | `false` | Generate `getToken(path)` helper |
| minify | `boolean` | `false` | Minify output |
...
```typescript
tailwind(config: TailwindOutputConfig): OutputConfig
```

### TailwindOutputConfig (extends OutputConfig)
...
```typescript
ios(config: IosOutputConfig): OutputConfig
```

### IosOutputConfig (extends OutputConfig)
...
| enumName | `string` | — | Custom enum name (enum mode) |
...
```typescript
android(config: AndroidOutputConfig): OutputConfig
```

### AndroidOutputConfig (extends OutputConfig)

| Option | Type | Default | Description |
|--------|------|---------|-------------|
| preset | `'standalone' \| 'bundle'` | `'standalone'` | Output preset |
| packageName | `string` | — | Kotlin package name (required) |
| objectName | `string` | — | Object/class name |
