...
Use for full build setups. Includes the Dispersa class, all builders, renderer utilities, [type guard functions](/reference/types/#type-guards), error classes, and all public types.
