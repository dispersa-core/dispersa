...
| `dispersa/errors`        | All 9 error classes                                                                                                                        | Error handling                  |
...
**Values:** `cssRenderer`, `jsRenderer`, `jsonRenderer`, `tailwindRenderer`, `iosRenderer`, `androidRenderer`, `outputTree`, `isOutputTree`, `defineRenderer`, `css`, `json`, `js`, `tailwind`, `ios`, `android`
...
import type { RenderContext, Renderer } from 'dispersa/outputs'
```
...
**Exports:** `DispersaError`, `TokenReferenceError`, `CircularReferenceError`, `ValidationError`, `FileOperationError`, `ConfigurationError`, `BasePermutationError`, `ModifierError`, `LintError`
